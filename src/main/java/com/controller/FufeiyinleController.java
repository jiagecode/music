...
public class FufeiyinleController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FufeiyinleEntity fufeiyinle,
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,FufeiyinleEntity fufeiyinle, 
		HttpServletRequest request){
        EntityWrapper<FufeiyinleEntity> ew = new EntityWrapper<FufeiyinleEntity>();
