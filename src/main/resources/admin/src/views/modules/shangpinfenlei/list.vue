			...
			<el-form class="center-form-pv" :style='{"width":"10%","padding":"0 20px","margin":"0 0 20px 0","background":"#fff"}' :inline="true" :model="searchForm">
				<el-row :style='{"alignItems":"center","flexDirection":"column","display":"flex"}' >
					<div :style='{"width":"100%","margin":"0","flexDirection":"column","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">商品分类</label>
				...
				<el-row :style='{"margin":"20px 0","alignItems":"center","flexDirection":"column","display":"flex"}'>
					<el-button :style='{"border":"1px solid ","cursor":"pointer","padding":"0 24px","margin":"0 0 6px","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('shangpinfenlei','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
					<el-button :style='{"border":"1px solid","cursor":"pointer","padding":"0 24px","margin":"0 0 6px","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('shangpinfenlei','删除')" :disabled="dataListSelections.length <= 0" type="danger" @click="deleteHandler()">删除</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('shangpinfenlei','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"1px solid","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('shangpinfenlei','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"1px solid","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"auto","fontSize":"14px","height":"32px"}' v-if="isAuth('shangpinfenlei','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
