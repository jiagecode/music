<template>
	<div class="navbar">
		<div class="title" :style='{"width":"100%","textAlign":"center","display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0","lineHeight":"44px","fontSize":"22px","color":"#fff","fontWeight":"600"}'>{{this.$project.projectName}}</span>
		</div>
