...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    <div class="section-title" :style='{"margin":"20px 7%","color":"#333","borderRadius":"20px","textAlign":"center","background":"#ceeff3","width":"86%","fontSize":"16px","lineHeight":"40px"}'>我的订单</div>
                        ...
                        if(item.type==1||item.type==3) {
                            ...
                            this.$http.post(table+'/update', this.user).then(res => {
                                ...
                                this.$http.post(`orders/update`, item).then(res => {
                                    if(item.tablename == `zhoubianshangpin`){
                                        // 加回库存数量
                                        good.alllimittimes = good.alllimittimes + item.buynumber;
                                        this.$http.post(`zhoubianshangpin/update`, good).then(res => {
                                        });
                                    }
                                    this.$message({
                                      message: '退款成功',
