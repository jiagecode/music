...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
    ...
    <div v-if="storeupType==41" class="section-title" :style='{"margin":"20px 7%","color":"#333","borderRadius":"20px","textAlign":"center","background":"#ceeff3","width":"86%","fontSize":"16px","lineHeight":"40px"}'>我的关注</div>
