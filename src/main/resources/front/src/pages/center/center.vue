    ...
    <el-tabs tab-position="left" :style='{"width":"100%","padding":"0 7%","background":"none"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="150px">
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="用户" prop="yonghu">
            <el-input v-model="sessionForm.yonghu" placeholder="用户" readonly></el-input>
          </el-form-item>
          ...
          <el-form-item class="balance" :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='yonghu'" label="余额">
            <div :style='{"flexWrap":"wrap","display":"flex"}'>
				...
				<div @click="dialogFormVisibleMoney = true" :style='{"border":"1px solid #eee","cursor":"pointer","padding":"0 15px","margin":"0 0 0 10px","color":"#333","display":"inline-block","outline":"none","borderRadius":"30px","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}'>点我充值</div>
			</div>
		  </el-form-item>
  ...
  export default {
    ...
    created() {
      if ('yonghu' == this.userTableName) {
        this.$set(this.sessionForm, 'yonghu', null);
      }
      if ('yonghu' == this.userTableName) {
      ...
      if ('yonghu' == this.userTableName) {
        this.$set(this.rules, 'yonghu', [{ required: true, message: '请输入用户', trigger: 'blur' }]);
      }
      if ('yonghu' == this.userTableName) {
