...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"0 outset #bcdbdf","padding":"30px 20px","margin":"20px 7% 0","alignItems":"center","flexWrap":"wrap","background":"#fff","borderWidth":"1px 0 2px","display":"flex","width":"86%","height":"auto"}'>
	  ...
	  <el-button v-if="isAuth('discussremengequ','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 10px","margin":"0 4px 0 0","color":"#fff","minWidth":"90px","outline":"none","borderRadius":"30px","background":"#f7aa00","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/discussremengequAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get('discussremengequ/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/discussremengequDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
